                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card card-primary">
                            <form action="{{ url('insertStduent') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="nameInput">Addmission Date <span style="color: red">*</span></label>
                                            <input type="date" class="form-control" id="nameInput" placeholder=""
                                                name="addmission_date" required>
                                        </div>
