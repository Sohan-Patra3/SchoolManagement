    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                {{-- <form action="{{ url('admin/assing_subject/search') }}" method="GET">
                    <div class="form-group">
                        <input type="text" class="form-control" id="nameInput" placeholder="Search Assing Subject"
                            name="search">
                                    ...
                                    <tbody>
                                        @foreach ($list as $value)
                                            <tr>
                                                ...
                                                <td> <a href="{{ url('admin/assing_subject/edit', $value->id) }}"
